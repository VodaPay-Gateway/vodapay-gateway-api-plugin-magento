...
/**
 * Vodapay-specific model for shopping cart items and totals
 * The main idea is to accommodate all possible totals into Vodapay-compatible 4 totals and line items
 */
