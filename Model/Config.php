...
/**
 * Config model that is aware of all \Vodapay\Vodapay payment methods
 * Works with PayNow-specific system configuration
...
class Config extends AbstractConfig
{
    ...
    /** @var \Vodapay\Vodapay\Model\Vodapay this is a model which we will use. */
    const METHOD_CODE = 'vodapay';
    ...
    /** Currency codes supported by PayNow methods @var string[] */
    ...
    /**
     * Return buyer country codes supported by PayNow
     *
     * @return string[]
     */
    ...
    {
        return $this->_assetRepo ? $this->_assetRepo->getUrl('Vodapay_Vodapay::images/logo.png') : 'https://github.com/Netcash-ZA/Vodapay-Magento-v2/blob/master/app/code/Vodapay/Vodapay/view/frontend/web/images/logo.png?raw=true';
    }

    /**
     * Get "What Is PayNow" localized URL
     * Supposed to be used with "mark" as popup window
     *
     * @return string
     */
    public function getPaymentMarkWhatIsVodapay()
    {
        return 'Pay Now Payment gateway';
    }

    /**
     * Mapper from PayNow-specific payment actions to Magento payment actions
     *
     * @return string|null
     */
    ...
    /**
     * _mapPayNowFieldset
     * Map PayNow config fields
     *
     * @param string $fieldName
     * @return string|null
     * @SuppressWarnings(PHPMD.CyclomaticComplexity)
     */
    protected function _mapVodapayFieldset($fieldName)
    {
    ...
    {
        return $this->_mapVodapayFieldset($fieldName);
    }
}
